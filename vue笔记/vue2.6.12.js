...
(function (global, factory) {
  ...
  function initProvide(vm) {
    console.log(
      "-----------------------执行了initMixin里面的Vue.prototype._init里面的initProvide"
    );
  ...
  function initInjections(vm) {
    console.log(
      "-----------------------执行了initMixin里面的Vue.prototype._init里面的initInjections"
    );
  ...
  function initRender(vm) {
    ...
    /* istanbul ignore else */
    console.log(
      "注意：给实例通过defineReactive添加$attrs和$listeners",
      parentData
    );
    {
      defineReactive$$1(
  ...
  function renderMixin(Vue) {
    console.log("注意：开始执行一系列操作的renderMixin");
  ...
  function initEvents(vm) {
    console.log(
      "-----------------------执行了initMixin里面的Vue.prototype._init里面的initEvents"
    );
  ...
  function eventsMixin(Vue) {
    console.log("注意：开始执行一系列操作的eventsMixin");
  ...
  function initLifecycle(vm) {
    console.log(
      "-----------------------执行了initMixin里面的Vue.prototype._init里面的initLifecycle"
    );
    var options = vm.$options;
  ...
  function lifecycleMixin(Vue) {
    console.log("注意：开始执行一系列操作的lifecycleMixin");
  ...
  function callHook(vm, hook) {
    console.log(
      "-----------------------执行了initMixin里面的Vue.prototype._init里面的callHook",
      hook
    );
  ...
  function stateMixin(Vue) {
    ...
    // the object here.
    console.log("注意：开始执行一系列操作的stateMixin");
    var dataDef = {};
  ...
  function Vue(options) {
    ...
    console.log("Vue.prototype._init", Vue.prototype._init);
    this._init(options);
  }
  ...
  function initExtend(Vue) {
    ...
    Vue.extend = function (extendOptions) {
      ...
      var Sub = function VueComponent(options) {
        console.log("function VueComponent执行了this._init", options);
        this._init(options);
      };
  ...
  function initGlobalAPI(Vue) {
    console.log("注意：开始执行一系列操作的initGlobalAPI");
    // config
    var configDef = {};
